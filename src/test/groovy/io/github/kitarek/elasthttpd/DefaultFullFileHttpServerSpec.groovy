...
class DefaultFullFileHttpServerSpec extends Specification {

	@Rule PowerMockRule powerMockRule = new PowerMockRule();

	def 'The default file HTTP server can be run passing fileserver plugin builder in READ/WRITE mode'() {
		given:
		...
		when:
			DefaultFullFileHttpServer.main(args)
